...
StyleX를 사용하는 Next.js 웹입니다. 설치와 공통 명령은 [workspace README](../../README.md)를 참고하세요. 이 폴더에서도 `pnpm dev`, `pnpm lint`, `pnpm format:check`, `pnpm build`를 실행할 수 있습니다. 기본 포트는 3000입니다.
